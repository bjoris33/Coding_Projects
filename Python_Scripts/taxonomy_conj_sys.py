...
fastaHeader={}
for file in glob.glob("/Volumes/data/gutDB/conjugative_operons/nucleotide_sequences/*"):
...
anvioHeader={}
with open("/Volumes/data/gutDB/conjugative_operons/name-change.txt") as anviofh:
    for line in anviofh:
...
headerlist=[]
with open("SAMPLES_MERGED-SPLITS.fa") as fafh:
    for line in fafh:
        if ">" in line:
